    ...
    <div className="bg-white min-h-screen w-full overflow-x-hidden font-sans text-black flex flex-col items-center">
      ...
      <section className="flex flex-col items-center text-center mt-16 px-4 md:mt-24">
        ...
        <button
          ...
          className="bg-[#d9d9d9] rounded-[20px] px-8 py-3 mt-12 font-['Inter'] font-medium tracking-[-0.5px] hover:bg-orange-600 hover:text-white transition"
        >
          Create your profile
        </button>
      </section>
      ...
      <section className="flex flex-col items-center text-center mt-32 px-4 w-full max-w-6xl mx-auto">
        ...
        <div className="relative w-full flex justify-center min-h-[700px] md:min-h-[900px] mb-20">
          ...
          <MotionImage
            ...
            className="absolute z-10 w-[200px] md:w-[320px] shadow-xl border border-gray-100
          ...
          <MotionImage
            ...
            className="absolute z-20 w-[200px] md:w-[320px] shadow-2xl border-4 border-white
          ...
          <MotionImage
            ...
            className="absolute z-30 w-[200px] md:w-[320px] shadow-xl border border-gray-100
      ...
      <section className="flex flex-col items-center text-center mt-32 px-4">
        ...
        <Image
          ...
          className="w-[200px] md:w-[248px] mt-12 shadow-lg"
          src={template2}
        />
      </section>
      ...
      <section className="flex flex-col items-center text-center mt-32 px-4">
        ...
        <Image
          alt="Template Terminal Single"
          className="w-[100px] md:w-[248px] mt-12 shadow-lg"
          src={suggestions}
        />
      </section>
      ...
      <section className="w-full flex justify-center mt-24 px-4 overflow-hidden">
        ...
        >
          ...
          <Image
            alt="Template Terminal"
            className="w-[200px] md:w-[238px] h-auto aspect-[1/2] object-cover snap-center shrink-0 shadow-sm"
            src={template5}
          />
          <Image
            ref={middleCardRef}
      ...
      {/* 6. FOOTER */}
      <footer className="w-full self-stretch bg-[#d9d9d9] mt-12 py-6 px-6 md:px-12 flex flex-col sm:flex-row justify-between items-center gap-4">
        {' '}
