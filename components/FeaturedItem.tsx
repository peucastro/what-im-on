  ...
  return (
    <div className="flex flex-col items-center w-full overflow-hidden">
      ...
      >
        ...
        <div className={`relative z-10 h-[100px] ${aspectClass} rounded-app overflow-hidden border-2 border-app-accent bg-app-nav flex-shrink-0 transition-all duration-300 ${isOwner ? 'group-hover/shelf:scale-105 group-hover/shelf:border-app-font' : ''}`}>
          {imageUrl ? (
            <Image 
              src={imageUrl} 
              alt={title} 
