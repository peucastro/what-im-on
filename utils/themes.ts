...
export const THEMES: Record<string, ThemeDefinition> = {
  ...
  nostalgic: {
    ...
    colors: {
      border: '#CCCCCC',
      headerImage: 'url(/headers/nostalgic.png)',
      headerBackground: '#76A5DF',
      profileBackground: '#76A5DF',
      font: '#000000',
      accent: '#76A5DF',
      secondaryAccent: '#76A5DF',
      overlay: 'none',
      navBackground: '#ffffff',
  ...
  forest: {
    ...
    colors: {
      ...
      headerBackground: '#98C355',
      profileBackground: '#98C355',
      font: '#000000',
      accent: '#98C355',
      secondaryAccent: '#98C355',
      overlay: 'none',
      navBackground: '#ffffff',
      pageBackground: '#E9F0E9',
    },
  },
  terminal: {
    id: 'terminal',
